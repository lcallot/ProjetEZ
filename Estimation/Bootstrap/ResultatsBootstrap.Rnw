...
a4<-lahiriboot2(iid1(200,betatrue,100),iter,0.05,nonzero,"post",betatrue)
...
b4<-lahiriboot2(depAR1(200,betatrue,100),iter,0.05,nonzero,"post",betatrue)
...
dataframe <- data.frame(Model =1:4,
                  "(p,n)"  = c("(10,100)", "(50,100)", "(120,100)", "(200,100)"),
                  lenght = sizeiid ,
                  cov1  = coviid1 ,
                  cov1  = coviid2 ,
                  cov1  = coviid3 ,
...
iter=10
beta=1
betatrue1=c(beta,beta,-beta,-beta,beta)
betatrue2=c(beta,beta,beta,beta,beta,-beta,-beta,-beta,-beta,-beta)

a1<-lahiriboot2(iid5(10,beta,beta,-beta,-beta,beta,100),iter,0.05,nonzero1,"post",betatrue1)
a2<-lahiriboot2(iid5(50,beta,beta,-beta,-beta,beta,100),iter,0.05,nonzero1,"post",betatrue1)
a3<-lahiriboot2(iid5(120,beta,beta,-beta,-beta,beta,100),iter,0.05,nonzero1,"post",betatrue1)
a4<-lahiriboot2(iid5(150,beta,beta,-beta,-beta,beta,100),iter,0.05,nonzero1,"post",betatrue1)

b1<-lahiriboot2(iid10(10,beta,beta,beta,beta,beta,-beta,-beta,-beta,-beta,-beta,100),iter,0.05,nonzero2,"post",betatrue2)
b2<-lahiriboot2(iid10(50,beta,beta,beta,beta,beta,-beta,-beta,-beta,-beta,-beta,100),iter,0.05,nonzero2,"post",betatrue2)
b3<-lahiriboot2(iid10(120,beta,beta,beta,beta,beta,-beta,-beta,-beta,-beta,-beta,100),iter,0.05,nonzero2,"post",betatrue2)
b4<-lahiriboot2(iid10(150,beta,beta,beta,beta,beta,-beta,-beta,-beta,-beta,-beta,100),iter,0.05,nonzero2,"post",betatrue2)
...
a1<-lahiriboot(iid5(10,1,2,1,3,6,100),iter,0.05,nonzero,"post")
a2<-lahiriboot(iid5(50,1,2,1,3,6,100),iter,0.05,nonzero,"post")
a3<-lahiriboot(iid5(120,1,2,1,3,6,100),iter,0.05,nonzero,"post")
a4<-lahiriboot(iid5(200,1,2,1,3,6,100),iter,0.05,nonzero,"post")


b1<-lahiriboot(iid5(10,1,2,1,3,6,100),iter,0.05,nonzero,"nonpost")
b2<-lahiriboot(iid5(50,1,2,1,3,6,100),iter,0.05,nonzero,"nonpost")
b3<-lahiriboot(iid5(120,1,2,1,3,6,100),iter,0.05,nonzero,"nonpost")
b4<-lahiriboot(iid5(200,1,2,1,3,6,100),iter,0.05,nonzero,"nonpost")
...
a1<-lahiriboot(depAR1(10,0.7,100),iter,0.05,nonzero,"post")
a2<-lahiriboot(depAR1(50,0.7,100),iter,0.05,nonzero,"post")
a3<-lahiriboot(depAR1(120,0.7,100),iter,0.05,nonzero,"post")
a4<-lahiriboot(depAR1(200,0.7,100),iter,0.05,nonzero,"post")

b1<-lahiriboot(depAR1(10,1,100),iter,0.05,nonzero,"post")
b2<-lahiriboot(depAR1(50,1,100),iter,0.05,nonzero,"post")
b3<-lahiriboot(depAR1(120,1,100),iter,0.05,nonzero,"post")
b4<-lahiriboot(depAR1(200,1,100),iter,0.05,nonzero,"post")
