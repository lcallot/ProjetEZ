...
{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in base::rowMeans(x, na.rm = na.rm, dims = dims, ...): 'x' doit être numérique}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in base::rowMeans(x, na.rm = na.rm, dims = dims, ...): 'x' doit être numérique}}

{\ttfamily\noindent\bfseries\color{errorcolor}{\#\# Error in base::rowMeans(x, na.rm = na.rm, dims = dims, ...): 'x' doit être numérique}}\end{kframe}
\end{knitrout}


% latex table generated in R 3.2.1 by xtable 1.7-4 package
% Thu Aug  6 15:27:23 2015
\begin{table}[ht]
\centering
\caption{Simulation Result 2} 
\label{Test_table}
...
\begin{tabular}{|r|r|rrrrr|rrrrr|}
 ...
 \midrule 
Model & X.p.n. & lenght & cov1 & fn & biais1 & biais2 & lenght2 & cov1.1 & fn2 & biais1.1 & biais2.1 \\ 
    1 & (50,100) & 0.261 & 0.140 & 2.398 & 0.215 & 0.159 & 0.279 &  & 0.000 & 0.173 & 0.191 \\ 
     2 & (100,100) & 0.268 & 0.087 & 11.545 & 0.262 & 0.197 & 0.300 &  & 0.000 & 0.214 & 0.248 \\ 
     3 & (200,100) & 0.266 & 0.046 & 23.203 & 0.312 & 0.231 & 0.322 &  & 0.000 & 0.248 & 0.307 \\ 
   \bottomrule 
\end{tabular}
}
}
